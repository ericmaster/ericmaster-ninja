...
import { A as AstroError, ai as ExpectedImage, aj as LocalImageUsedWrongly, ak as MissingImageDimension, al as UnsupportedImageFormat, am as IncompatibleDescriptorOptions, an as UnsupportedImageConversion, ao as toStyleString, ap as NoImageMetadata, aq as FailedToFetchRemoteImageDimensions, ar as ExpectedImageOptions, as as ExpectedNotESMImage, at as InvalidImageService, b as createAstro, c as createComponent, au as ImageMissingAlt, m as maybeRenderHead, d as addAttribute, s as spreadAttributes, r as renderTemplate, av as ExperimentalFontsNotEnabled, aw as FontFamilyNotFound, u as unescapeHTML } from './astro/server_Bd8-x6y9.mjs';
import { D as DEFAULT_HASH_PROPS, a as DEFAULT_OUTPUT_FORMAT, b as VALID_SUPPORTED_FORMATS } from './internal_Bjh2Ot_R.mjs';
...
const $$Astro$2 = createAstro("https://ericmaster.github.io");
...
const $$Astro$1 = createAstro("https://ericmaster.github.io");
...
const $$Font = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Font;
  const { fontsData } = await import('./internal_Bjh2Ot_R.mjs').then(n => n.i).catch(() => {
...
export { _astro_assets as _, isRemoteAllowed as a, baseService as b, getConfiguredImageService as g, imageConfig as i, lookup as l };
