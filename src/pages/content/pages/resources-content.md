...
- **[Agent Fabric](/resources/agent-fabric)**: Multi-harness portable agent system and adapter CLI (`agf`) — install and sync canonical agents across OpenCode, Kilo, Antigravity CLI, Codex, and Claude Code without overwriting customizations.
